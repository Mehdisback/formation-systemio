...
## 3. Accéder à votre landing page "L'Essentiel en Soi"
...
## 4. Mode édition de la landing page
...
- **Enregistrer** : Sauvegarde vos modifications (brouillon)
- **Aperçu** : Voir la page sans la publier
- **Publier** : Mettre en ligne les modifications
- **Paramètres** : Configuration avancée de la page

---

## 5. Concept de blocs dans Systeme.io

Systeme.io fonctionne avec un système de **blocs** ou **sections**.
...
> ⚠️ **Attention :** Toujours enregistrer avant de quitter l'éditeur !

---

## 6. Visualisation multi-appareils

### Pourquoi tester sur différents appareils ?

Plus de **60% des visiteurs** consultent votre page depuis un smartphone.

### Basculer entre les vues

En bas de l'éditeur, trois icônes permettent de basculer :

- 💻 **Desktop** : Vue ordinateur (1920px de large)
- 📱 **Mobile** : Vue smartphone (375px de large)
- 📱 **Tablet** : Vue tablette (768px de large)

> 💡 **Conseil :** Toujours vérifier vos modifications en vue mobile avant de publier.

---

## 7. Enregistrer et publier vos modifications
...
> ⚠️ **Important :** Une fois publié, les changements sont immédiatement visibles par tous vos visiteurs.

---

## 8. Navigation rapide - Raccourcis clavier

### Raccourcis utiles

|Raccourci|Action|
|---|---|
|`Ctrl + S` (Windows) / `Cmd + S` (Mac)|Enregistrer|
|`Ctrl + Z`|Annuler|
|`Ctrl + Y`|Rétablir|
...
## 9. Checklist de première connexion

Assurez-vous d'avoir fait ces étapes :

- [ ] Connexion réussie à Systeme.io
- [ ] Navigation dans le Dashboard
- [ ] Localisation du tunnel "L'Essentiel en Soi"
- [ ] Ouverture de l'éditeur de page
- [ ] Compréhension du système de blocs
- [ ] Test des vues Desktop/Mobile
- [ ] Enregistrement d'une modification test
- [ ] Prévisualisation de la page
- [ ] Compréhension de la différence Enregistrer/Publier
